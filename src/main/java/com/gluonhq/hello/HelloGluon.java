...
//            try {
//                    root = FXMLLoader.load(HelloGluon.class.getResource("views/hello.fxml"),
//                        ResourceBundle.getBundle("com.gluonhq.hello.views.hello"));
//            } catch (Exception e) {
//                System.err.println(e.getMessage()); 
//                System.err.println("Caused by . . ." + e.getCause()); 
//            }
 
            View view = new View(new Hellofxml()) {
                @Override
